...
public class MyAlarmReceiver extends BroadcastReceiver {
	 ...
	 * 出现一个提示信息.
	 */
	private void showNotify(Context ct, String str, String indate) {
	...
	public void onReceive(Context context, Intent arg1) {
		...
		String content = arg1.getStringExtra("tipContent");
		String indate = arg1.getStringExtra("time");
		showNotify(context, content, indate);
	}
